...
public class ScanQRPOM {

		public ScanQRPOM(AppiumDriver<AndroidElement> driver) {
		...
		//Click on Scan QR button on home Screen
		@AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/scan_bottom_nav"))
		public AndroidElement ScanQRClick;

	
		//Click on Enable Camera Button
		@AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/yesButton"))
		public AndroidElement EnableCameraButton;
		
		
		//Click on Gallery
		@AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/tillNmr"))
		public AndroidElement TillIDButton;
		
		
		//Verigy the QR Payment Screen
		@AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/txtSendMoneyTitle"))
		public AndroidElement QRPayment;
